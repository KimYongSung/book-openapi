...
public class ResourceUtil {
	...
	private static boolean isClassPath(String path) {
		return StringUtil.isEmpty(path) ? false : path.startsWith(CLASSPATH_URL_PREFIX);
	}
	...
	private static boolean isFile(String path) {
		return StringUtil.isEmpty(path) ? false : path.startsWith(FILE_URL_PREFIX);
	}
	...
	public static boolean isXML(String path) {
		return StringUtil.isEmpty(path) ? false : path.toLowerCase().endsWith(XML_EXTENSION);
	}
	...
	public static boolean isJSON(String path) {
		return StringUtil.isEmpty(path) ? false : path.toLowerCase().endsWith(JSON_EXTENSION);
	}
