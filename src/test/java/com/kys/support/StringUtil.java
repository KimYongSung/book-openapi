...
public class StringUtil {
	...
	public static String nullValue(Object str, String nullStr){
	...
	public static String[] split(String source, String separator) throws NullPointerException {
		...
		while (index >= 0) {
			returnVal[cnt] = source.substring(index0, index).trim();
			index0 = index + 1;
			index = source.indexOf(separator, index + 1);
			cnt++;
		}
	...
	public static int[] splitAndIntArr(String source, String separator) throws NullPointerException {
		int[] returnVal = null;
		int cnt = 1;
		...
		returnVal = new int[cnt];
		cnt = 0;
		index = source.indexOf(separator);
		while (index >= 0) {
			returnVal[cnt] = Integer.parseInt(source.substring(index0, index).trim());
			index0 = index + 1;
			index = source.indexOf(separator, index + 1);
			cnt++;
		}
		returnVal[cnt] = Integer.parseInt(source.substring(index0));

		return returnVal;
	}

	public static long[] splitAndLongArr(String source, String separator) throws NullPointerException {
		long[] returnVal = null;
		int cnt = 1;
		...
		returnVal = new long[cnt];
		cnt = 0;
		index = source.indexOf(separator);
		while (index >= 0) {
			returnVal[cnt] = Long.parseLong(source.substring(index0, index).trim());
			index0 = index + 1;
			index = source.indexOf(separator, index + 1);
			cnt++;
		}
		returnVal[cnt] = Long.parseLong(source.substring(index0));
	...
	public static boolean isContainTxt(String text, String str){
